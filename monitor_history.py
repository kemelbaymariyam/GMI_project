...
Usage in another tmux pane:
  watch -n 30 'python monitor_history.py --history checkpoints_fixed_h5/history.csv --tail 10'

Or just:
  python monitor_history.py --history checkpoints_fixed_h5/history.csv --plot
"""
